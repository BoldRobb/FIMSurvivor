...
public class Recursador extends Enemigos{

	public Recursador(Texture textura, float x, float y, int ancho, int alto, float vida, Body body, World mundo) {
		super(textura, x, y, ancho, alto, vida, body, mundo);
		// TODO Auto-generated constructor stub
		
	}
	public Recursador(int x, int y, World mundo) {
		this.drop2="Azul";
		this.drop1="Rojo";
		this.textura = new Texture("SpritesAnimacion/Recursador64.png");
	...
	public static Recursador devolverObjetoBody(Body body) {
		return (Recursador) body.getUserData();
	}
}
