...
public class ProfesorEnemy2 extends Enemigos{
	public ProfesorEnemy2(Texture textura, float x, float y, int ancho, int alto, float vida, Body body, World mundo) {
		super(textura, x, y, ancho, alto, vida, body, mundo);
		// TODO Auto-generated constructor stub
		
	}
	public ProfesorEnemy2(int x, int y, World mundo) {
		this.drop2="Amarillo";
		this.drop1="Rojo";
	...
	public static ProfesorEnemy2 devolverObjetoBody(Body body) {
		return (ProfesorEnemy2) body.getUserData();
	}
}
