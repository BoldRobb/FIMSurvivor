...
public class MYobani extends Boss{

	public MYobani(Texture textura, int x, int y, int ancho, int alto, float vida, Body cuerpo, float armor, World mundo) {
		super(textura, x, y, ancho, alto, vida, cuerpo, armor, mundo);
		// TODO Auto-generated constructor stub
	}
	public MYobani(int x, int y, World mundo) {
		this.drop2="Azul";
		this.drop1="Azul";
		this.textura = new Texture("SpritesAnimacion/Yobani64.png");
	...
	public static MYobani devolverObjetoBody(Body body) {
		return (MYobani) body.getUserData();
	}
