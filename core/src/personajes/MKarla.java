...
public class MKarla extends Boss {

	public MKarla(Texture textura, int x, int y, int ancho, int alto, float vida, Body cuerpo, float armor, World mundo) {
		super(textura, x, y, ancho, alto, vida, cuerpo, armor, mundo);
		// TODO Auto-generated constructor stub
	}
	public MKarla(int x, int y, World mundo) {
		this.drop2="Azul";
		this.drop1="Azul";
		this.textura = new Texture("SpritesAnimacion/MaestraKarla64.png");
	...
	public static MKarla devolverObjetoBody(Body body) {
		return (MKarla) body.getUserData();
	}
