...
public class MFigueroa extends Boss{
	public MFigueroa(Texture textura, int x, int y, int ancho, int alto, float vida, Body cuerpo, float armor, World mundo) {
		super(textura, x, y, ancho, alto, vida, cuerpo, armor, mundo);
		// TODO Auto-generated constructor stub
	}
	public MFigueroa(int x, int y, World mundo) {
		this.drop2="Azul";
		this.drop1="Azul";
	...
	public static MFigueroa devolverObjetoBody(Body body) {
		return (MFigueroa) body.getUserData();
	}
