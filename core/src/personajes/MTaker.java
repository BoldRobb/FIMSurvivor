...
public class MTaker extends Boss{
	
	public MTaker(Texture textura, int x, int y, int ancho, int alto, float vida, Body cuerpo, float armor, World mundo) {
		super(textura, x, y, ancho, alto, vida, cuerpo, armor, mundo);
		// TODO Auto-generated constructor stub
	}
	public MTaker(int x, int y, World mundo) {
		this.drop2="Azul";
		this.drop1="Azul";
		this.textura = new Texture("SpritesAnimacion/Taker64.png");
	...
	public static MTaker devolverObjetoBody(Body body) {
		return (MTaker) body.getUserData();
	}
